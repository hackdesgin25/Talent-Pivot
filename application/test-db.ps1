...
Write-Host "1. MySQL user sqlserver does not exist OR" -ForegroundColor White
Write-Host "2. User sqlserver cannot connect from Cloud Run IPs OR" -ForegroundColor White
Write-Host "3. Password is incorrect OR" -ForegroundColor White
Write-Host "4. Database candidate_hub does not exist" -ForegroundColor White
Write-Host ""
